...
const HomePage = () => {
    ...
    return (
        <div className="container w-full md:w-4xl mx-auto p-4 grid grid-cols-0 md:grid-cols-12">
            <div className="space-y-4 col-span-1 md:col-span-11 pr-4">
                {!newTaskOpen && (
                    <button
                ...
                {newTaskOpen && (
                    <div className="flex">
                        <div className="bg-white shadow-xl rounded-xl w-full p-4 flex justify-between">
                            <div className="font-semibold text-xl text-gray-800">
                                Create New Task
                            </div>
                            <div className="md:hidden font-semibold text-red-500 text-xl cursor-pointer" onClick={() => setNewTaskOpen(!newTaskOpen)}>
                                x
                            </div>
                        </div>
                    </div>
